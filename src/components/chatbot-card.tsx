...
import { BarChart, Bot, Edit, Share2 } from 'lucide-react';
...
export function ChatbotCard({ chatbot, onDeploy }: ChatbotCardProps) {
  return (
    <Card>
      <CardHeader>
      ...
      <CardFooter className="flex justify-end gap-2">
        ...
        <Button variant="default" onClick={() => onDeploy(chatbot)} className="bg-accent text-accent-foreground hover:bg-accent/90">
          <Share2 />
          Deploy
        </Button>
      </CardFooter>
